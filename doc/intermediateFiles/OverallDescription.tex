...
The stone identification app will provide the same functions as rock identification sites, with added features such as value approximation. The application will work by asking multiple questions to refine the result, as internet quizzes often do. The product will make use of google maps and therefore will not be completely self contained. 
